...
/*#####################################################################################################################################*/
if(isNil("acd_fnc_build"))then{acd_fnc_build = compile preprocessFile "addons\tanoa_bridge\functions\acd_fnc_build.sqf";};
if(isNil("acd_fnc_removeObj"))then{acd_fnc_removeObj = compile preprocessFile "addons\tanoa_bridge\functions\acd_fnc_removeObj.sqf";};
if(isNil("acd_fnc_removeGreen"))then{acd_fnc_removeGreen = compile preprocessFile "addons\tanoa_bridge\functions\acd_fnc_removeGreen.sqf";};
if(isNil("acd_fnc_precompileProps"))then{acd_fnc_precompileProps = compile preprocessFile "addons\tanoa_bridge\functions\acd_fnc_precompileProps.sqf";};
