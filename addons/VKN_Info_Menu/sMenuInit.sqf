...
SC_fnc_ctrLbAdd = compileFinal preprocessFileLineNumbers "Addons\VKN_Info_Menu\functions_SC\sMenu_fnc_ctrLbAdd.sqf";
SC_fnc_getContent = compileFinal preprocessFileLineNumbers "Addons\VKN_Info_Menu\functions_SC\sMenu_fnc_getContent.sqf";
SC_fnc_handleCtrlText = compileFinal preprocessFileLineNumbers "Addons\VKN_Info_Menu\functions_SC\sMenu_fnc_handleCtrlText.sqf";
SC_fnc_getCfgSetting = compileFinal preprocessFileLineNumbers "Addons\VKN_Info_Menu\functions_SC\sMenu_fnc_getCfgSetting.sqf";
SC_fnc_f5Reload = compileFinal preprocessFileLineNumbers "Addons\VKN_Info_Menu\functions_SC\sMenu_fnc_f5Reload.sqf";
SC_fnc_sMenuOpen = compileFinal preprocessFileLineNumbers "Addons\VKN_Info_Menu\functions_SC\sMenu_fnc_sMenuOpen.sqf";
...
{
	_sMenuAddAction = player addaction["<t color='#D13B3B'>{VKN}</t> Server Info Menu", { _this select 3 call SC_fnc_sMenuOpen }, _settings,-1,false,true,"", ""];
};