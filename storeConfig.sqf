...
[
	...
	["Cyrus Rifle", "srifle_DMR_05_blk_F", 10000],
...
[
	...
	["Mk32 GMG 20mm Low tripod", "B_GMG_01_F", 20000],
	["Mk32 GMG 20mm Low tripod", "O_GMG_01_F", 20000],
	["Mk32 GMG 20mm Low tripod", "I_GMG_01_F", 20000],
	so 
...
[
	...
	["Suppressor 5.56mm", "muzzle_snds_M", 10000, "item"],
	["Suppressor 5.56mm (Khaki)", "muzzle_snds_m_khk_F", 10000, "item"],
	["Suppressor 5.56mm (Sand)", "muzzle_snds_m_snd_F", 10000, "item"],
	["Suppressor 5.8mm", "muzzle_snds_58_blk_F", 10000, "item"],
	["Suppressor 5.8mm (G Hex)", "muzzle_snds_58_wdm_F", 10000, "item"],
	["Suppressor 6.5mm", "muzzle_snds_H", 10000, "item"],
	["Suppressor 6.5mm (Khaki)", "muzzle_snds_H_khk_F", 10000, "item"],
	["Suppressor 6.5mm (Sand)", "muzzle_snds_H_snd_F", 10000, "item"],
	["Suppressor 6.5mm LMG", "muzzle_snds_H_MG", 125, "item"],
	["Suppressor 6.5mm LMG (Black)", "muzzle_snds_H_MG_blk_F", 10000, "item"],
	["Suppressor 6.5mm LMG (Khaki)", "muzzle_snds_H_MG_khk_F", 10000, "item"],
	["Suppressor Type 115", "muzzle_snds_65_TI_blk_F", 10000, "item"],
	["Suppressor Type 115 (Hex)", "muzzle_snds_65_TI_hex_F", 10000, "item"],
	["Suppressor Type 115 (G Hex)", "muzzle_snds_65_TI_ghex_F", 10000, "item"],
	["Suppressor 7.62mm", "muzzle_snds_B", 10000, "item"],
	["Suppressor 7.62mm (Khaki)", "muzzle_snds_B_khk_F", 10000, "item"],
	["Suppressor 7.62mm (Sand)", "muzzle_snds_B_snd_F", 10000, "item"],
	["Suppressor .338", "muzzle_snds_338_black", 10000, "item"],
	["Suppressor .338 (Green)", "muzzle_snds_338_green", 10000, "item"],
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 10000, "item"],
	["Suppressor 9.3mm", "muzzle_snds_93mmg", 10000, "item"],
	["Suppressor 9.3mm (Tan)", "muzzle_snds_93mmg_tan", 10000, "item"],
